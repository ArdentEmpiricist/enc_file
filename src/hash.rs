...
///
/// This function supports multiple hash algorithms for different use cases:
/// - Cryptographic hashes: BLAKE3, SHA-256, SHA-512, SHA3-256, SHA3-512, BLAKE2b
/// - Non-cryptographic hashes: XXH3-64, XXH3-128, CRC32 (for integrity checking only)
...
///
/// Uses a buffered reader and feeds the hasher in chunks for memory efficiency.
/// Suitable for large files without loading them entirely into memory.
...
///
/// Same as `hash_bytes_keyed_blake3` but for files, using streaming for memory efficiency.
